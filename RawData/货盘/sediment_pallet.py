...
- 输出：
  - data\product_assets.csv           扁平化产品资产表
  - data\discovered_modules.csv       从升级思路中挖出的模块候选
- 编码：UTF-8 with BOM（Excel 双击不乱码）
"""
import openpyxl, os, csv, re, sys, datetime

SRC_DIR = r"D:\1.work\5-20\货盘"
OUT_DIR = r"D:\1.work\5-20\data"
